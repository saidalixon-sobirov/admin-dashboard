...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Serius TEAM.">
        <meta name="author" content="SaidAliKhan">
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="http://serius.uz" class="text-success">
                                            <span><img src="../media/steam1.png" alt="" height="86"></span>
                                        </a>
                                    </h2>
