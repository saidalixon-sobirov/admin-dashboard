    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>Trainers </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="aboutus.php">Кафедра ҳақида</a></li>
                        <!-- <li><a href="contactus.php">Contact us</a></li> -->
                        <li><a href="uslubiyishlar.php">Услубий ишлар</a></li>
                        <li><a href="ilmiytadqiqotishlar.php">Илмий-тадқиқот ишлар</a></li>
                        <li><a href="manaviymarifiyishlar.php">Маънавий-маърифий ишлар</a></li>
                        
                    </ul>
                </li>
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Фотолавҳалар </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="add-gallery.php">Расм қўшиш</a></li>
        ...
        <div class="help-box">
            ...
            <p class=""><span class="text-custom">Email:</span> <br/> seriusTeam@gmail.com</p>
        </div>
    </div>
    <!-- Sidebar -left -->
</div>