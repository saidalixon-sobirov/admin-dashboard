...
if($query)
{
$msg="Ilmiy tadqiqot Ishlar page successfully updated ";
}
else{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Ilmiy tadqiqot ishlar </h4>
...
?>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-6">
                                    <div class="">
                                        <form name="ilmiytadqiqotishlar" method="post">
